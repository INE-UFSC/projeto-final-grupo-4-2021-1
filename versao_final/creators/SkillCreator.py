...
class SkillCreator():
    ...
    def create_skills():
        ...
        skills.append(Skill([DamageEffect(100, DamageType.FIRE, 100, 0, EffectTarget.ENEMY)], 1, 1, "FIRE BALL!!!", "versao_final/assets/skill_icons/fireball-red-1.png", animation, enemy_animation))

        #FORTIFY SKILL
        skills.append(Skill([HealingEffect(80, EffectTarget.SELF), BuffEffect(Buff(0.2, BuffTarget.RESISTANCE, DamageType.ALL), 2, EffectTarget.SELF)], 1, 2, "Heal and resistance", "versao_final/assets/skill_icons/heal-jade-1.png", None))
        ...
        skills.append(Skill([DamageEffect(240, DamageType.SLASHING, 100, 10, EffectTarget.ENEMY)], 2, 3, "Slashing", "versao_final/assets/skill_icons/slash.png", animation, enemy_animation))
        ...
        skills.append(Skill([DamageEffect(100, DamageType.EARTH, 100, 0, EffectTarget.ENEMY)], 1, 1, "Flying stone!", "versao_final/assets/skill_icons/stone.png", animation, enemy_animation))
        ...
        skills.append(Skill([DamageEffect(150, DamageType.EARTH, 100, 0, EffectTarget.ENEMY), DamageEffect(250, DamageType.FIRE, 100, 0, EffectTarget.ENEMY)], 4, 6, "FLYING FLAMING STOOOONE!!!", "versao_final/assets/skill_icons/meteor.png", animation, enemy_animation))
