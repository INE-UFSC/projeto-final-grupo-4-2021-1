...
class SkillCreator():
    ...
    def create_skills():
        ...
        skills.append(Skill([DamageEffect(240, DamageType.SLASHING, 100, 10, EffectTarget.ENEMY)], 2, 3, "Slashing", "prototipo/assets/skill_icons/slash.png", animation))
        ...
        skills.append(Skill([DamageEffect(100, DamageType.EARTH, 100, 0, EffectTarget.ENEMY)], 1, 1, "Flying stone!", "prototipo/assets/skill_icons/stone.png", animation))
        ...
        skills.append(Skill([DamageEffect(150, DamageType.EARTH, 100, 0, EffectTarget.ENEMY), DamageEffect(250, DamageType.FIRE, 100, 0, EffectTarget.ENEMY)], 4, 6, "FLYING FLAMING STOOOONE!!!", "prototipo/assets/skill_icons/meteor.png", animation))
